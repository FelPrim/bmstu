##### 13/02/2025
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250213085210.png)
$$\begin{gather}
...
\end{gather}
$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250213090553.png)
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250213091730.png)
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250213092051.png)
$$\begin{gather}
\begin{cases}
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250213092842.png)
$$|z-z_{1}|+|z-z_{2}|=2a$$
...
\end{cases}
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250213094724.png)
$$\begin{gather}
|z+i|<|z-1|
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250213095048.png)
$$\begin{gather}
|x+iy+i|<|x+iy-1|\\
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250213101413.png)
##### 20/02/2025
Пропустил
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250227091534.png)
$$\begin{gather}
\beta-\alpha=\arg f'(z)\\
...
u=1
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306114502.png)
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306114509.png)
$$\begin{gather}
y=\frac{3}{2}x \\
...
\text{а) } y=3x
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306115917.png)
$$\begin{gather}
...
v=-3u
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306120513.png)
$$\begin{gather}
\text{б) }y=x-1 \\
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306121038.png)
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306121409.png)
$$\begin{gather}
...
v=u-\frac{1}{2}
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306122209.png)
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306122214.png)
$$\begin{gather}
\text{в) } \lvert z-2-2i \rvert =1 \\

\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306122306.png)
$$\begin{gather}
(x-2)^2+(y-2)^2=1 \\
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306122914.png)
$$\begin{gather}
f(z)=\frac{z-2i}{z+2} \\
\text{а) } y=x+2 \\
...
v=0
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306124600.png)
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306124757.png)
...
\end{cases}
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306125030.png)
Следующие соображения
$$\begin{gather}
f(z)=- \frac{z-z_{1}}{z-z_{2}}

\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306125552.png)
$$\begin{gather}
w_{1}=f(z_{1})=0 \\
w_{2}=f(z_{2})=\infty \\
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250306125657.png)
ДОДЕЛАТЬ ЗАДАЧУ!!!
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250403130836.png)
$$\begin{gather}
...
$$\underset{ z=0 }{\operatorname{Res}} \frac{\sin z}{z^2}=\underset{ z=0 }{\operatorname{Res}} \frac{\frac{\sin z}{z}}{z}=\frac{\frac{\sin z}{z}|_{0}}{1}=1 $$
