...
Мещерский 27.65
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250211104108.png)
1. Естественный способ задания
2. Силы
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250211110356.png)
...
27.5
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250211110613.png)
1. ДСК
2. Силы: $m\vec{g}$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250211110856.png)
1. $$\begin{align}
\vec{a}=\frac{\vec{F}}{m} \\
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250211113503.png)
1. ДСК
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218102629.png)
$$\begin{gather}
\text{Дано: }\\
...
\vec{a_{к}}=2\vec{\omega_{e}}\times \vec{V_{r}}\\
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218103306.png)
$$\begin{gather}
...
Динамика материальной точки
Колесников
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218112307.png)
$$\begin{gather}
\text{Дано:}\\
t_{0}=0, V_{r}(0)=0\\
\text{Найти:}\\
...
\text{Решение:}\\
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218112541.png)
$$\begin{gather}
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Drawing%202025-02-25%2010.39.34.excalidraw)
Уравнение движения центра масс
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Drawing%202025-02-25%2011.22.25.excalidraw)
Дано:
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250311134159.png)
$$\begin{gather}
...
\end{gather}$$
Решение:
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250311135853.png|360)
...
\end{gather}$$
Решение:
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250311141143.png)
$$\begin{gather}
...
\end{gather}$$
Решение:
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250311142142.png)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250401132833.png)
$$\begin{gather}
...
\end{cases}
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250401142407.png)
$$\begin{gather}
\alpha=30\degree,h \\
t=0-\text{ покой} \\
V_{C} (t_{1})=? \\
