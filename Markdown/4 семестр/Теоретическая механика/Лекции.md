...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218141604.png)
$$\begin{gather}
...
\vec{F}=f(\vec{r})\vec{r}\\
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218143837.png|320)
$$\begin{gather}
m\vec{a}=\vec{F}\\
\end{gather}$$
...
\end{gather}$$
Введём полярную ось
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218144359.png)
$$\begin{gather}
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218145057.png)
$$\begin{gather}
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218150307.png|320)
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250218151321.png)
$$\begin{gather}
\begin{cases}
f_{1}=0 \\
f_{2}=0
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250225141532.png|280)
$$\vec{R}^{(i)}=\sum_{j=1}^{N} \vec{F}_{j}^{(i)}=\vec{0}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250225141810.png|240)
$$\begin{gather}
\begin{cases}
...
\end{cases}
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250225142051.png|240)
Алгебраического решения для задачи 3х тел не существует.
Поиск общих теорем динамики.
###### Общие теоремы динамики
1) $i=1\ldots n$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250225142419.png|240)
2) Инерциальная система отсчёта
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250225142527.png|240)
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250225144016.png|240)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250225145120.png|240)
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250225151114.png)
$$\begin{gather}
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250304142608.png|320)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250304143951.png|480)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250304145058.png|480)
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250304150217.png|480)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250304150850.png|320)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250304151638.png|480)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250304152139.png|320)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250311171846.png)
$$\begin{gather}
I_{OZ}=I_{iZ}+mOC^2 \\
...
\end{gather}$$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250311172655.png)
$$\begin{gather}
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250401173742.png|320)
3. Плоское движение:
Рассматриваем центр масс
$\vec{\text{Ф}}=-M\vec{a}_{C}$
$L^\text{Ф}_{CZ}=-I_{CZ}\varepsilon_{Z}$
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250401174102.png|320)
...
![Illustration](https://github.com/FelPrim/bmstu/blob/master/obsidian%20stuff/attachments/Pasted%20image%2020250401182740.png)
$$\begin{gather}
n=1 \\
\#\{ \vec{R}_{i} \}=5 \\
