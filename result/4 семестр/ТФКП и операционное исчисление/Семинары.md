...
=\mathrm{Im}\left( 2\pi i\underset{ z=\frac{-1+\sqrt{ 3 }i}{2} }{\operatorname{Res}} \frac{ze^{iz}}{z^2+z+1} \right)=\mathrm{Im}\left( 2\pi i \frac{z\exp(iz)}{2z+1} \vert_{z=\frac{-1+\sqrt{ 3 }i}{2}} \right)=\mathrm{Im}\left( 2\pi i \frac{\frac{-1+\sqrt{ 3 }i}{2}e^{-i/2}e^{-\sqrt{ 3 }/2}}{\sqrt{ 3 }i}  \right)=  \\ 
...
2\pi i\underset{ z=2i }{\operatorname{Res}} f=2\pi i \frac{\left( \frac{e^{iz}}{z} \right)}{2z}\vert_{z=2i}=\pi i\cdot \frac{e^{i\cdot 2i}}{(2i)^2}=-\frac{\pi i}{4e^2}  \\ 
...
\underset{ z=-\frac{i}{\sqrt{ 3 }} }{\operatorname{Res}} f=\frac{1}{2\sqrt{ 3 }z+4i}\vert_{z=-\frac{i}{\sqrt{ 3 }}}
\end{gather}$$
