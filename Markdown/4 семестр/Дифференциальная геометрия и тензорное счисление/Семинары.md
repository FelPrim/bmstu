...
Задать вопрос можно ли конспектировать на ноуте
...
\vec{R^{1}}\vec{R_{1}}=\left( \frac{1}{3}\vec{e_{1}}\cdot \frac{1}{3}\vec{e_{2}} \right)(2\vec{e_{1}}+\vec{e_{2}})=\frac{4}{3}-\frac{1}{3}=1\\
